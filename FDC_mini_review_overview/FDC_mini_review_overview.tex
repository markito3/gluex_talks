...
\f{
  ...
  Map the spectrum of hybrid mesons (gluonic excitations)
    ...
    \I Go on to look for hybrids with non-exotic quantum numbers
    \ei
\begin{columns}[c]
  \begin{column}{2in}
...
$$
  \centerline{lattice mass predictions}
  \end{column}
\end{columns}
}
...
\hline
Ground	plane & mylar & 1.3900 & 0.00009 & 0.00002 \\
...
Rohacell & Rohacell & 0.0320 & 0.00039 & 0.00016 \\
\hline				
Thickness per plane &&& 0.00213 & 0.00097 \\
Thickness per package &&& 0.01275 & 0.00582 \\			
Thickness for 4 packages &&& 0.05100 & 0.02327 \\
\hline
\end{tabular}
}
...
\f{
  ...
  \begin{columns}[c]
    \begin{column}{2.5in}
        \bi
        \I drift chamber and cathode strip chamber technology
        \I no structural segmentation in azimuth (no $\phi$ sectors)
        \I pipeline readout: deadtime-less front end electronics
