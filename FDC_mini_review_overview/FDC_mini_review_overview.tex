...
\f{
  ...
  \onslide<1->{
    \bi
    \I $t$-channel meson photoproduction: $\sigma(t)\propto e^{-\alpha t}$
...
\multicolumn{7}{c}{Material budget per package}\\\hline
Material & Thickness & Number & Density  & Total & Radiation & X/X$_0$ \\
& (cm) & of layers & (g/cm$^3$) & thickness & length (X$_0$) &  \\
& & & & (g/cm$^2$) & (g/cm$^2$) & \\
\hline
Rohacell  & 0.20000 & 12 & 0.032 & 0.077 & 41.04  & 0.00187 \\
Epoxy         & 0.00200 & 12 & 1.08 & 0.026 & 40 & 0.00065  \\
Kapton        & 0.00250 & 12 & 1.42 & 0.043 & 40.56 &  0.00106\\
Copper        & 0.00020 & 12 & 8.96 & 0.022 & 12.86 &  0.00168\\
Ground planes &         &    &      &       &       &         \\
(Mylar)       & 0.00063 &  5 & 1.39 & 0.004 & 39.95  & 0.00011 \\
Gas windows   &         &    &      &       &       &          \\
(Mylar)       & 0.00250 &  2 & 1.39 & 0.007 & 39.95 & 0.00017 \\
Argon       & 12.7$\times$0.4 & 1 & 1.65$\times 10^{-3}\dag$ & 0.008 &
19.55 &
0.00043 \\
CO$_2$       & 12.7$\times$0.6 & 1 & 1.83$\times 10^{-3}\dag$ & 0.014 &
36.20 &
0.00039\\
\hline
Total       &     &      &   &  0.185 & & 0.00636\\
Total (4 packages) & & & & {\bf 0.740}& &{\bf 0.0254} \\\hline
& & & \dag 70$^\circ$F, 1 atm &  &  &
\end{tabular}
}
...
\f{
  ...
  \only<1>{
    ...
    $$
    \centerline{March 2007 Geometry, dual cathode FDC, frame $\rightarrow$ $76\%\times X_0$}
  }
  \only<2>{
    $$
    \includegraphics[height=2.0in]{all_particles_stop_A_geomcd3dualcathode.jpg}
    $$
    \centerline{February 2008 Geometry, dual cathode FDC, frame $\rightarrow$ $39\%\times X_0$}
  }
}
...
\f{
  \ft{momentum resolution}
\begin{columns}[t]
  \begin{column}{1.8in}
  \bi
  \I $\sigma_{p_t}/p_t$ for various designs
  \I double-cathode design assumes 24 wire planes + 48 cathode planes
  \I wires-only design assumes 72 measurement planes
  \ei
  \end{column}
  \begin{column}{2.8in}
    $$
    \includegraphics[width=2.8in]{FDC_resolution.jpg}
    $$
  \end{column}
\end{columns}
}
