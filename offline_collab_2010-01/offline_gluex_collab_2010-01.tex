...
\f{
\bi
\I FDC Half-Cell Stagger Study\cite{half-cell}: Simon
  \bi
  \I Conclude that planes with half-cell wire stagger not necessary
  \ei
\I Alternate B-Field maps available\cite{alt-B}: David (slide)
\I Position-Dependent Position Resolution\cite{pos-res-dep}: Yves calculated the effect, David has implemented it
