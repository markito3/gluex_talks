...
\I still have to introduce automatic code profiling
\ei
}
...
\bi
\I need robust SRM
\I pursue production on both JLab farm and on grid
\I huge sample of Pythia data is a reasonable, useful goal
...
\f{
\includegraphics[width=4.5in]{fracture.jpg}
}
