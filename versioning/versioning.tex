...
\I Assume that {\tt /home/username/gluex} hiearchy already built once.
\ei
{\footnotesize
\begin{verbatim}
setenv GLUEX_TOP /home/username/gluex           # define top of hierarchy
...
\f{
\ft{Future Work}
System is useable. Already incoporated into {\tt gluex\_install}. However, a bit more work needed...
\bi
