...
\f{\ft{Analysis}
  ...
  \I new development: Analysis Tools
    \bi
...
\section{Data Challenges}
  \subsection{Data Challenge I -- November/December 2012}
    ...
    \f{\ft{Data Challenge I: Results}
      \bi
      \I 5.3 giga-events
      \I massive data set (2 weeks of data rate, 3 months of physics data)
      \ei
    }
    \f{\ft{Data Challenge I: Lessons Learned}
      \bi
      \I tools need development (JLab CC may help here)
      \I need meta-data catalog
      \ei
    }
  \subsection{Online Data Challenge I -- August 2013}
    ...
    \f{\ft{Level 3 Farm Throughput}
      ...
      \I Data ready-to-analyze, but none done
